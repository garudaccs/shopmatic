...
// Proper product names (all_products.json titles contain affiliate URLs)
const productNames: Record<string, string> = {
  ...
  'impact': 'Impact',
  'blinkist': 'Blinkist',
  'envato-placeit': 'Envato Placeit',
  'getresponse': 'GetResponse',
  'filmora': 'Wondershare Filmora',
  'brevo': 'Brevo',
  'seowriting': 'SEOWriting AI',
...
const defaultPricing: Record<string, { price: string; type: 'free' | 'freemium' | 'paid' }> = {
  // Batch 1: Verified via official pricing pages (May 2026)
  'insecureweb': { price: 'Free tier available', type: 'freemium' },
  'loom': { price: 'Free tier available', type: 'freemium' },
  'grammarly': { price: 'Free tier available', type: 'freemium' },
  'elevenlabs': { price: 'Free tier available', type: 'freemium' },
  'perplexity': { price: 'Free tier available', type: 'freemium' },
  'windsurf': { price: 'Free tier available', type: 'freemium' },
  'bolt': { price: 'Free tier available', type: 'freemium' },
  'replit': { price: 'Free tier available', type: 'freemium' },
  'filmora': { price: 'Free tier available', type: 'freemium' },
  'brevo': { price: 'Free up to 250 contacts', type: 'freemium' },
  'getresponse': { price: 'Free up to 250 contacts', type: 'freemium' },
  'appsumo': { price: 'From $49/lifetime deals', type: 'paid' },
  'namecheap': { price: 'From $5.98/year', type: 'paid' },
  'blinkist': { price: 'Free (1 title/day)', type: 'freemium' },
  'envato': { price: 'From $16.50/month', type: 'paid' },
  // Batch 2: Verified via official pricing pages
  'gamma': { price: 'Free tier available', type: 'freemium' },
  'kling': { price: 'Free tier available', type: 'freemium' },
  'skool': { price: 'From $9/month', type: 'paid' },
  'make': { price: 'Free tier available', type: 'freemium' },
  'railway': { price: 'Free trial available', type: 'freemium' },
  'mindvalley': { price: 'From $698/year', type: 'paid' },
  'minimax': { price: 'Free tier available', type: 'freemium' },
  'lovable': { price: 'Free tier available', type: 'freemium' },
  'warp': { price: 'Free tier available', type: 'freemium' },
  'contabo': { price: 'From $4.50/month', type: 'paid' },
  'camo': { price: 'Free tier available', type: 'freemium' },
  'supercut': { price: 'Free tier available', type: 'freemium' },
  'ninjachat': { price: 'From $11/month', type: 'freemium' },
  'teamgpt': { price: 'Contact for pricing', type: 'paid' },
  'netdata': { price: 'Free up to 5 nodes', type: 'freemium' },
  // Batch 3: Verified via official pricing pages
  ...
  'seowriting': { price: 'Free tier available', type: 'freemium' },
  'uptimerobot': { price: 'Free up to 50 monitors', type: 'freemium' },
  'impact': { price: 'From $30/month', type: 'paid' },
  'amazon': { price: '$14.99/month (Prime)', type: 'paid' },
  'envato-placeit': { price: 'From $14.95/month', type: 'paid' },
  'clawcloud': { price: 'Free tier available', type: 'freemium' },
  'postnitro': { price: 'Free tier available', type: 'freemium' },
  'racknerd': { price: 'From $17.99/year', type: 'paid' },
  // Products with limited/no public pricing info
  'MFXfy': { price: 'Contact for pricing', type: 'paid' },
  'ilh': { price: 'From ₹500/course', type: 'paid' },
  'wealthy': { price: 'Free to use', type: 'freemium' },
  'publit': { price: 'Contact for pricing', type: 'paid' },
  'offers': { price: 'Free to use', type: 'free' },
  'campfire': { price: 'Free trial available', type: 'freemium' },
  'getzai': { price: 'Contact for pricing', type: 'paid' },
  'wispr': { price: 'Free tier available', type: 'freemium' },
  ...
  return Object.values(allProducts).map((product) => {
    ...
    if (research) {
      return {
        ...
        image: `/images/products/${slug}-card.jpg`,
    ...
    return {
      id: product.channel_item_id.toString(),
      alias: product.alias,
      title: productNames[slug] || product.title.replace(/^https?:\/\/[^\\/]*\/?/gi, '').replace(/^Join\s+/i, '').replace(/\s*[:\-]\s*.*$/i, '').replace(/\.{3,}/g, '').trim() || slug.charAt(0).toUpperCase() + slug.slice(1),
      slug: slug,
      short_url: product.short_url,
